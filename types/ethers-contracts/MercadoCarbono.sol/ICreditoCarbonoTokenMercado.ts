...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface ICreditoCarbonoTokenMercadoInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'safeTransferFrom', data: BytesLike): Result;
  ...
  export interface ICreditoCarbonoTokenMercado extends BaseContract {
    
    connect(runner?: ContractRunner | null): ICreditoCarbonoTokenMercado;
    waitForDeployment(): Promise<this>;

    interface: ICreditoCarbonoTokenMercadoInterface;
