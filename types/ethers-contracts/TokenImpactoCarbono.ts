...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface TokenImpactoCarbonoInterface extends Interface {
    getFunction(nameOrSignature: "allowance" | "approve" | "balanceOf" | "decimals" | "emitirTokens" | "name" | "owner" | "renounceOwnership" | "symbol" | "totalSupply" | "transfer" | "transferFrom" | "transferOwnership"): FunctionFragment;
...
encodeFunctionData(functionFragment: 'emitirTokens', values: [AddressLike, BigNumberish]): string;
...
decodeFunctionResult(functionFragment: 'emitirTokens', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
  ...
  export interface TokenImpactoCarbono extends BaseContract {
    
    connect(runner?: ContractRunner | null): TokenImpactoCarbono;
    waitForDeployment(): Promise<this>;

    interface: TokenImpactoCarbonoInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    emitirTokens: TypedContractMethod<
      [destinatario: AddressLike, quantidade: BigNumberish, ],
      [void],
      'nonpayable'
    >
...
getFunction(nameOrSignature: 'decimals'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'emitirTokens'): TypedContractMethod<
      [destinatario: AddressLike, quantidade: BigNumberish, ],
      [void],
      'nonpayable'
    >;
