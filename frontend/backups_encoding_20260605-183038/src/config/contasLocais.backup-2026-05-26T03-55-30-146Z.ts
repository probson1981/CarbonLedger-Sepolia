 ...
 *
 * @dev
 * Este arquivo permite que o frontend identifique os papéis lógicos
 * das contas locais do Hardhat.
 *
 * Observação:
 * O script não consegue renomear contas dentro do MetaMask.
 * A renomeação visual no MetaMask continua sendo manual.
 * Este arquivo serve para o frontend exibir os nomes corretos
 * dentro da aplicação CarbonLedger.
 */
...
/**
 * @notice
 * Lista das contas locais principais do CarbonLedger.
 */
...
/**
 * @notice
 * Obtém os dados lógicos de uma conta local pelo endereço.
 *
 * @param endereco Endereço conectado no MetaMask.
 *
 * @returns Dados da conta local ou undefined.
 */
...
/**
 * @notice
 * Retorna descrição amigável da conta conectada.
 *
 * @param endereco Endereço conectado no MetaMask.
 *
 * @returns Texto com nome e papel da conta.
 */
