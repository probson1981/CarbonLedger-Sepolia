 ...
 *
 * @notice
 * Configuração centralizada dos endereços dos contratos do CarbonLedger.
 *
 * @dev
 * Este arquivo separa os endereços por rede.
 *
 * A seção localhost foi atualizada com os endereços gerados pelo deploy local.
 */
...
export function resolverNomeRede(
  ...
  const valor = String(identificadorRede).toLowerCase();
